...
1. **Download the public GPG key:**
  `curl -fsSL https://aaronlomas.github.io/boveda/boveda-archive-keyring.gpg | sudo gpg --dearmor -o /usr/share/keyrings/boveda-archive-keyring.gpg`
  
2. **Add the repository to APT sources:**
  `echo "deb [arch=amd64 signed-by=/usr/share/keyrings/boveda-archive-keyring.gpg] https://aaronlomas.github.io/boveda stable main" | sudo tee /etc/apt/sources.list.d/boveda.list > /dev/null`
