...
<div class="grid gap-4">
    ...
    <div class="flex overflow-x-auto gap-3 pb-2">
      {#each PRESETS as preset}
        ...
        >
          ...
          <span class="text-xs font-medium text-text-primary leading-tight text-center"
  ...
  <div class="grid grid-cols-2 gap-3 mt-1">
    ...
    >
      ...
      >
      <button class="w-full py-2 bg-accent text-white rounded text-xs font-bold"
      ...
      >
        ...
        >
          {#if themeStore.bgType === "image" && themeStore.bgValue}
            <span class="text-xs text-text-muted text-center px-1 leading-tight font-bold"
              >OK</span
            >
          {:else}
